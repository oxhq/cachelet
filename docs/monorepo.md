...
- `cachelet-cloud` owns first-party export of canonical Cachelet telemetry records.

## Public Publishing Model

- `oxhq/cachelet` is published from the root of this repository.
- `oxhq/cachelet-core`, `oxhq/cachelet-model`, `oxhq/cachelet-query`, `oxhq/cachelet-request`, and `oxhq/cachelet-cloud` are published from split repositories generated from `packages/*`.
